                ...
                <nav className="flex justify-between items-center">
                    ...
                    <div className='flex-grow flex justify-center items-center'>
                        <ul className='hidden md:flex gap-7 text-black'>
                            <li><a href="#Header" className="relative border-2  border-gray-800 bg-transparent py-2.5 px-5 font-medium uppercase text-gray-800 transition-colors before:absolute before:left-0 before:top-0 before:-z-10 before:h-full before:w-full before:origin-top-left before:scale-x-0 before:bg-green-400 before:transition-transform before:duration-300 before:content-[''] hover:text-white before:hover:scale-x-100">Home</a></li>
